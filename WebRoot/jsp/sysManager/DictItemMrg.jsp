...
<script type="text/javascript">
	...
	var xx = {x:"123",
			  x1:["aa","bb"],
			  fn:function(){alert("ggggggg");}};
	/*特殊对象 JSON对象*/
	var vr = {v:[{a:"AA",b:"BB"},{a:"CC",b:"DD"}]};
	
	var v = {item:[{dictId:"5",dictCode:"C1",dictValue:"CS001",groupCode:"TEST",groupName:"测试",sn:"1",status:"0",remark:"null"},
	               {dictId:"8",dictCode:"C4",dictValue:"CS004",groupCode:"TEST",groupName:"测试",sn:"2",status:"0",remark:"null"},
	               {dictId:"6",dictCode:"C2",dictValue:"CS002",groupCode:"TEST",groupName:"测试",sn:"3",status:"0",remark:"null"},
	               {dictId:"7",dictCode:"C3",dictValue:"CS003",groupCode:"TEST",groupName:"测试",sn:"4",status:"0",remark:"null"}]}
	...
	function _onCgGroupList(val)
	{
		...
		for(var i in array)
		{
			alert(array[i].dictId+"-----"+array[i].dictCode);
		}*/
		if(val!=null&&""!=val){
		xmlHttp = new XMLHttpRequest();
		xmlHttp.open("GET","<%=path%>/dictMrg?flag=queryDict&groupCode="+val,true);
	...
	function rollBack()
	{
		if(xmlHttp.readyState == 4 && xmlHttp.status == 200)
		{
			...
			for(var i in array)
			{
				...
				_td6.innerHTML = "<input type='button' value='删除' onclick='_delRow(this)'/><input type='button' value='修改' onclick='_modify(this)'/>";
...
<hr>
		<table id="dictTab" width="100%" border="1" cellpadding="0" cellspacing="0">
			<tr>
				<th>字典组Code</th>
				<th>字典组Value</th>
				<th>序列</th>
